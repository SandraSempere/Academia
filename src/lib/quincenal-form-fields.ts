...
export const QUINCENAL_SECTIONS: QuincenalSection[] = [
  {
    ...
    fields: [
      ...
      { id: "dolorAbdominal", label: "Dolor abdominal", type: "chips", options: chips("No | A veces | Sí", [g, n, c]) },
      ...
      { id: "estrenimiento", label: "Estreñimiento", type: "chips", options: chips("No | A veces | Sí", [g, n, c]) },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "alimentosSinDigerir", label: "¿Alimentos sin digerir?", type: "chips", options: chips("Sí | No", [c, g]) },
